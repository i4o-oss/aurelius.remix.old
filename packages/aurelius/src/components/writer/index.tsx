...
import { AmplitudeEventType, ToolbarMode, WriterProps } from '../../types'
...
export default function Writer({
    ...
    const [toolbarMode] = useLocalStorage<ToolbarMode>(
        ...
        <KeystrokesProvider keystrokes={keystrokes}>
            <AureliusProvider data={data}>
                <main className='au-flex au-h-full au-w-full au-flex-col au-items-center au-justify-start'>
                    ...
                    {toolbarMode === 'fixed' ? (
                        <div
                            className={`au-absolute au-top-4 au-left-[50%] -au-translate-x-[50%] au-flex au-items-center au-gap-4 au-transition-all au-duration-200 hover:au-opacity-100 ${focusMode ? 'au-opacity-5' : 'au-opacity-100'
                                }`}
                        >
                    ...
                    {/* <WritingPaths /> */}
                    <section
                        className={`au-flex au-h-full au-w-full au-flex-grow au-flex-col au-items-center au-justify-start ${toolbarMode === 'fixed' ? 'au-py-20' : ''}`}
                    >
