	...
	const TABS = [
		{
			...
			content: (
				...
				>
					...
					{/* 	/> */}
					{/* </div> */}
					<div className='[&_div[role="group"]]:au-divide-y-0 [&_div[role="group"]]:au-divide-x au-flex au-flex-col au-w-full au-items-start au-justify-center au-gap-2 au-text-white [&_button[role="radio"]]:au-col-span-1 [&_button[role="radio"]]:au-rounded-none [&_div[role="group"]]:au-grid [&_div[role="group"]]:au-w-full [&_div[role="group"]]:au-grid-cols-2 [&_div[role="group"]]:au-overflow-hidden [&_div[role="group"]]:au-rounded-lg'>
						<label className='au-text-sm au-font-medium au-text-black dark:au-text-white'>
							Daily Goal
						</label>
						<ToggleGroup
