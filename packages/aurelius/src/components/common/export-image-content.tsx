...
const ExportImageContent = forwardRef<HTMLDivElement, ExportImageContentProps>(
	(
		...
		return (
			<div className='au-min-h-full au-flex au-items-center au-justify-center au-flex-1 au-flex-grow'>
				<div
				...
				>
					...
					>
						<h1
							className={`au-w-full au-flex au-flex-col au-text-gray-900 au-font-semibold !au-mb-2 ${
								titleAlignment === 'left'
									? 'au-text-left'
									: 'au-text-center'
							}`}
						...
						{author ? (
							<p
								className={`au-w-full au-flex au-flex-col au-text-gray-900 au-font-medium !au-my-2 ${
									titleAlignment === 'left'
										? 'au-text-left'
										: 'au-text-center'
								}`}
