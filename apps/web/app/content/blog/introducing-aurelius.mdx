...
The editor is free to use locally and has a good set of features. I'm working on premium features that will take the base experience to a whole new level. [Follow me on Twitter](https://twitter.com/i4o_dev) for updates.
