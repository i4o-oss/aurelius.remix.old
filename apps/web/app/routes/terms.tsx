	...
	return (
		<div className='flex min-h-[calc(100vh-10rem)] w-full flex-col'>
			<div className='relative mx-auto flex w-full max-w-5xl flex-col justify-center gap-16 px-6 py-20 sm:py-32 lg:px-8 lg:py-40'>
				...
				<div className='prose flex w-full max-w-3xl flex-col items-start leading-loose text-white'>
					<p>Welcome to Aurelius!</p>

					<p>
						These terms and conditions outline the rules and
						regulations for the use of Aurelius's Website, located
						at https://aurelius.ink.
					</p>

					<p>
						By accessing this website, we assume you accept these
						terms and conditions. Do not continue to use Aurelius if
						you do not agree to take all of the terms and conditions
						stated on this page. Cookies:
					</p>

					<p>
						The website uses cookies to help personalize your online
						experience. By accessing Aurelius, you agreed to use the
						required cookies.
					</p>

					<p>
						A cookie is a text file that is placed on your hard disk
						by a web page server. Cookies cannot be used to run
					...
					<p>
						...
						they always work. Please keep in mind that by accepting
						required Cookies, you also accept third-party Cookies,
						which might be used via third-party provided services if
						you use such services on our website, for example, a
						video display window provided by third parties and
						integrated into our website. License:
					</p>

					<p>
						Unless otherwise stated, Aurelius and/or its licensors
						own the intellectual property rights for all material on
						Aurelius. All intellectual property rights are reserved.
						You may access this from Aurelius for your own personal
					...
					<ul>
						<li>Copy or republish material from Aurelius</li>
						<li>
							Sell, rent, or sub-license material from Aurelius
						</li>
						<li>
							Reproduce, duplicate or copy material from Aurelius
						</li>
						<li>Redistribute content from Aurelius</li>
					</ul>
					...
					<p>
						Aurelius reserves the right to monitor all Comments and
					...
					<p>
						You hereby grant Aurelius a non-exclusive license to
					...
					<p>
						...
						Aurelius; and (d) the link is in the context of general
					...
					<p>
						...
						you must inform us by sending an e-mail to Aurelius.
					...
					<p>
						No use of Aurelius's logo or other artwork will be
